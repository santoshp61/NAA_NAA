    ...
    <div className="flex min-h-screen bg-black text-white">
      ...
      <div className="w-64 bg-[#111] shadow-xl p-6 flex flex-col gap-6 border-r border-yellow-600">
        ...
        <nav className="flex flex-col gap-4 text-gray-300">
          <button className="hover:text-yellow-400 hover:font-semibold text-left transition-all">
            User Details
          </button>
      ...
      <div className="flex-1 p-10">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Cards */}
          <div className="bg-[#1a1a1a] p-6 rounded-xl shadow-lg border border-yellow-700 hover:scale-105 transition">
