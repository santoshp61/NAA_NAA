  ...
  return (
    <section className="w-full py-16 bg-gray-900">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="text-lg text-gray-100 mb-4">
          Whether you are looking for insights, services, or simply a place to engage with meaningful content, NAA NAA is the platform that connects you to endless possibilities.
